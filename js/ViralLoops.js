...
class ViralLoops {
    ...
    trackShare(platform) {
        ...
        if (this.shareCount === 1) {
            this._awardAchievement(
                "first_share",
                _("First Share!"),
                _("You shared your first project")
            );
                        ...
                        this.copyShareLink(projectId).then(success => {
                            if (success) {
                                e.currentTarget.innerHTML =
                                    '<i class="material-icons">check</i>' + _("Copied!");
                                setTimeout(() => {
                                    e.currentTarget.innerHTML =
                                        '<i class="material-icons">content_copy</i>' +
                                        _("Copy Link");
        ...
        const achievementsList = [
            {
                id: "first_share",
                title: _("First Share"),
                description: _("Share your first project"),
                unlocked: this.achievements.includes("first_share")
            },
            {
                id: "social_butterfly",
                title: _("Social Butterfly"),
                description: _("Share 5 projects"),
                unlocked: this.achievements.includes("social_butterfly")
            },
            {
                id: "influencer",
                title: _("Influencer"),
                description: _("Share 10 projects"),
                unlocked: this.achievements.includes("influencer")
            }
        ];

        const achievementsHTML = achievementsList
            .map(
                ach => `
